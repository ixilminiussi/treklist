...
import { createTrek, joinTrek, getTrek, closeTrek, kickTrekker, listUserTreks, resumeGuest } from './handlers/treks'
import {
...
app.post('/api/treks/:code/resume-guest', resumeGuest)
